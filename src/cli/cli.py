...
class CLI:
    ...
    def agregar_especialidad(self):
        ...
        try:
            ...
            especialidad = self.clinica.agregar_especialidad_a_medico(matricula, tipo_especialidad, dias)
    ...
    def agendar_turno(self):
        ...
        try:
            ...
            turno = self.clinica.agendar_turno(dni_paciente, matricula_medico, fecha, hora, especialidad)
    ...
    def emitir_receta(self):
        ...
        try:
            ...
            receta = self.clinica.emitir_receta(dni_paciente, matricula_medico, fecha, medicamentos, indicaciones)
