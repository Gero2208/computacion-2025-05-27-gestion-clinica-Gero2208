...
class TestHistoriaClinica(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.otro_paciente = Paciente("María García", "87654321", "15/05/1985")
    ...
    def test_agregar_turno_valido(self):
        ...
        self.assertEqual(turnos[0].obtener_fecha(), "16/06/2025")
    ...
    def test_agregar_turno_paciente_diferente(self):
        turno_otro_paciente = Turno(self.otro_paciente, self.medico, "16/06/2025", "10:30", "Pediatría")
    ...
    def test_agregar_receta_valida(self):
        receta = Receta(self.paciente, self.medico, "15/06/2025", 
                       ["Paracetamol 500mg"], "Tomar cada 8 horas")
        self.historia.agregar_receta(receta)
        
        recetas = self.historia.obtener_recetas()
        self.assertEqual(len(recetas), 1)
        self.assertEqual(recetas[0].obtener_fecha(), "15/06/2025")
    ...
    def test_agregar_receta_paciente_diferente(self):
        receta_otro_paciente = Receta(self.otro_paciente, self.medico, "15/06/2025", 
                                     ["Paracetamol 500mg"], "Tomar cada 8 horas")
    ...
    def test_multiples_turnos_y_recetas(self):
        turno1 = Turno(self.paciente, self.medico, "16/06/2025", "10:30", "Pediatría")
        turno2 = Turno(self.paciente, self.medico, "18/06/2025", "15:00", "Pediatría")
        
        self.historia.agregar_turno(turno1)
        self.historia.agregar_turno(turno2)
        
        receta1 = Receta(self.paciente, self.medico, "15/06/2025", 
                        ["Paracetamol 500mg"], "Tomar cada 8 horas")
        receta2 = Receta(self.paciente, self.medico, "17/06/2025", 
                        ["Ibuprofeno 400mg"], "Tomar cada 12 horas")
    ...
    def test_representacion_historia_clinica(self):
        ...
        self.assertIn("Juan Perez", representacion_vacia)
