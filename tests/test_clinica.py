...
class TestClinica(unittest.TestCase):
    ...
    def test_registrar_paciente_valido(self):
        paciente = self.clinica.registrar_paciente("Juan Perez", "12345678", "01/01/1990")
    ...
    def test_registrar_paciente_dni_duplicado(self):
        self.clinica.registrar_paciente("Juan Perez", "12345678", "01/01/1990")
        
        with self.assertRaises(DatosInvalidosException):
            self.clinica.registrar_paciente("María García", "12345678", "15/05/1985")
    
    def test_registrar_medico_valido(self):
        medico = self.clinica.registrar_medico("Dr. Ana García", "M12345")
        
        self.assertEqual(medico.obtener_matricula(), "M12345")
        self.assertEqual(medico.obtener_nombre(), "Dr. Ana García")
    
    def test_registrar_medico_matricula_duplicada(self):
        self.clinica.registrar_medico("Dr. Ana García", "M12345")
        
        with self.assertRaises(DatosInvalidosException):
            self.clinica.registrar_medico("Dr. Carlos López", "M12345")
    ...
    def test_agendar_turno_valido(self):
        ...
        turno = self.clinica.agendar_turno(
            "12345678", "M12345", "16/06/2025", "10:30", "Pediatría"
        )
    ...
    def test_agendar_turno_paciente_inexistente(self):
        ...
        with self.assertRaises(PacienteNoEncontradoException):
            self.clinica.agendar_turno(
                "99999999", "M12345", "16/06/2025", "10:30", "Pediatría"
            )
    ...
    def test_agendar_turno_medico_inexistente(self):
        ...
        with self.assertRaises(MedicoNoEncontradoException):
            self.clinica.agendar_turno(
                "12345678", "M99999", "16/06/2025", "10:30", "Pediatría"
            )
    
    def test_agendar_turno_ocupado(self):
        self.clinica.registrar_paciente("Juan Perez", "12345678", "01/01/1990")
        self.clinica.registrar_paciente("María García", "87654321", "15/05/1985")
        self.clinica.registrar_medico("Dr. Ana García", "M12345")
        self.clinica.agregar_especialidad_a_medico(
            "M12345", "Pediatría", ["lunes", "miércoles", "viernes"]
        )
        ...
        with self.assertRaises(TurnoOcupadoException):
            self.clinica.agendar_turno(
                "87654321", "M12345", "16/06/2025", "10:30", "Pediatría"
            )
    ...
    def test_emitir_receta_paciente_inexistente(self):
        ...
        with self.assertRaises(PacienteNoEncontradoException):
            self.clinica.emitir_receta(
                "99999999", "M12345", "15/06/2025", 
                ["Paracetamol 500mg"], "Tomar según indicaciones"
            )
    ...
    def test_listar_medicos(self):
        ...
        self.clinica.registrar_medico("Dr. Ana García", "M12345")
        self.clinica.registrar_medico("Dr. Carlos López", "M67890")
